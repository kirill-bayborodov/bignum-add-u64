 ...
 * @brief Single-thread benchmark-framework entrypoint for bignum scalar addition.
 */
...
int main(int argc, char **argv)
{
    ...
    if (bignum_add_u64_benchmark_adapter_init(&adapter) != BIGNUM_ADD_U64_BENCHMARK_STATUS_SUCCESS) {
        return 2;
    }
